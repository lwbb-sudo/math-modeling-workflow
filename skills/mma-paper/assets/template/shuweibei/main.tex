...
\usepackage{tikz}
\mcmsetup{CTeX = true,
        tcn ={\xiaowuhao 2024000000001 }(\textcolor{red}{\textit{需要修改为自己队伍的实际队号}}), problem = A,
        sheet = true, titleinsheet = false, keywordsinsheet = true,
        titlepage = true, abstract = true}
\usepackage{xurl}
\setmainfont{Times New Roman}
% \setmonofont{...} (removed — font not on macOS)
...
\begin{figure}[h!t]
\centerline{\fbox{\parbox[c][3cm][c]{0.75\textwidth}{\centering 替换为论文图片}}}
\caption{示例图片位置}
\end{figure}
...
\begin{figure}[h!t]
\centerline{\fbox{\parbox[c][4cm][c]{0.8\textwidth}{\centering 替换为论文图片}}}
\caption{\song\wuhao 示例图片位置}
\end{figure}
...
% 下方原有 \bibitem 仅为模板示例，提交前必须逐条核验或替换；核验不了的文献宁可不引。
