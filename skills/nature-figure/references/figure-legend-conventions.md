...
> **Scope — journal submissions only.** These are *Nature-family journal*
> conventions: a self-contained, 300-word legend that carries the panel-by-panel
> description, colour mappings and a closing claim. **Do not apply them to a
> Chinese modelling-competition paper (CUMCM / 全国大学生数学建模竞赛,
> `cumcmthesis.cls`), a thesis, or any document whose own style guide sets the
